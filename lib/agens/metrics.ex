defmodule Agens.Metrics do
  ...
  def metrics() do
    [
      counter("agens.agent.start", event_name: [:agens, :agent, :start], tags: []),
      counter("agens.agent.stop", event_name: [:agens, :agent, :stop], tags: []),
      ...
      counter("agens.tool.call", event_name: [:agens, :tool, :call], tags: []),
